...
2. I check for errors (`result` returns a promise with a `.error` attribute ³)
...
4. Since it’s an array, I can now loop over it using a `forEach` to generate a page using Gatsby’s built-in `actions`.  Gatsby uses Redux to manage state and ships with a series of built in actions (of which `createPage` is one). ⁴
...
* ¹ [Getting Started With Gatsby-Source-Filesystem | /* Code Comments */](https://www.stephencharlesweiss.com/2019-07-20/gatsby-source-filesystem/)
* ² [How To Use Variables GraphQL Queries | /* Code Comments */](https://www.stephencharlesweiss.com/2019-07-24/graphql-variable-queries/)
* ³[Programmatically create pages from data | GatsbyJS](https://www.gatsbyjs.org/tutorial/part-seven/#creating-pages)
* ⁴ [Actions | Gatsby](https://www.gatsbyjs.org/docs/actions/) 
