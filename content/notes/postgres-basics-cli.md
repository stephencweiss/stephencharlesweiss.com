...
Before you can [connect to a Postgres database](access-psql-via-shell/) from the command line, it needs to be running.
...
![Roles & Permissions](https://res.cloudinary.com/scweiss1/image/upload/v1593203498/roles-and-permissions_i4qca1.png)
...
![Alter role](https://res.cloudinary.com/scweiss1/image/upload/v1593203498/alter-role_kxsbxo.png)
...
![Regular user prompt](https://res.cloudinary.com/scweiss1/image/upload/v1593203498/regular-user-prompt_px7nqy.png)
